...
# Generated on 2025/02/28 09:26 from http://services.odata.org/V4/Northwind/Northwind.svc/$metadata
#
...
class Employee(ReflectionBase):
    ...
    Employee1: "Employee" = NavigationProperty(name="Employee1", entity_package="generated.northwind", entitycls="Employee")
    Orders: list["Order"] = NavigationProperty(name="Orders", entity_package="generated.northwind", entitycls="Order", collection=True)
...
class Order_Detail(ReflectionBase):
    ...
    # Navigation properties
    Order: "Order" = NavigationProperty(name="Order", entity_package="generated.northwind", entitycls="Order")
    Product: "Product" = NavigationProperty(name="Product", entity_package="generated.northwind", entitycls="Product")
...
class Order(ReflectionBase):
    ...
    # Navigation properties
    Customer: "Customer" = NavigationProperty(name="Customer", entity_package="generated.northwind", entitycls="Customer")
    Employee: "Employee" = NavigationProperty(name="Employee", entity_package="generated.northwind", entitycls="Employee")
    ...
    Shipper: "Shipper" = NavigationProperty(name="Shipper", entity_package="generated.northwind", entitycls="Shipper")
...
class Product(ReflectionBase):
    ...
    # Navigation properties
    Category: "Category" = NavigationProperty(name="Category", entity_package="generated.northwind", entitycls="Category")
    Order_Details: list["Order_Detail"] = NavigationProperty(name="Order_Details", entity_package="generated.northwind", entitycls="Order_Detail", collection=True)
    Supplier: "Supplier" = NavigationProperty(name="Supplier", entity_package="generated.northwind", entitycls="Supplier")
...
class Territory(ReflectionBase):
    ...
    # Navigation properties
    Region: "Region" = NavigationProperty(name="Region", entity_package="generated.northwind", entitycls="Region")
